...
class TestImport(TestCase):
    ...
    def test_post(self):
        responses.add(
            responses.GET, 'http://example.com/good-story.html', body="""<!DOCTYPE HTML>
<html ⚡>
    <head>
        <meta charset="utf-8">
        <title>Wagtail spotting</title>
        <link rel="canonical" href="http://example.com/good-story.html">
    ...
    <body>
        <amp-story standalone
            ...
            poster-portrait-src="https://example.com/wagtails.jpg">
        ...
        response = self.client.post('/admin/webstories/import/', {
            'source_url': 'http://example.com/good-story.html',
    ...
    def test_post_not_story(self):
        responses.add(
            responses.GET, 'http://example.com/bad-story.html', body="""<!DOCTYPE HTML>
<html>
    <head>
        <meta charset="utf-8">
        <title>Not a story</title>
        <link rel="canonical" href="http://example.com/bad-story.html">
    </head>
    <body>
        ...
        response = self.client.post('/admin/webstories/import/', {
            'source_url': 'http://example.com/bad-story.html',
            'destination': self.home.pk,
        })
    ...
    def test_post_broken_url(self):
        responses.add(
            responses.GET, 'http://example.com/broken-link.html',
            body=HTTPError("Something went wrong")
        )
        response = self.client.post('/admin/webstories/import/', {
            'source_url': 'http://example.com/broken-link.html',
            'destination': self.home.pk,
        })
    ...
    def test_no_permission(self):
        responses.add(
            responses.GET, 'http://example.com/story.html', body="..."
        )
        ...
        response = self.client.post('/admin/webstories/import/', {
            'source_url': 'http://example.com/story.html',
            'destination': self.home.pk,
        })
        self.assertEqual(response.status_code, 200)
